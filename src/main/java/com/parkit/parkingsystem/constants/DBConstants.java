...
public class DBConstants {
    ...
    public static final String NUMBER_TICKET = "select count(distinct ID) as result from ticket where VEHICLE_REG_NUMBER=?";
    public static final String UPDATE_TEST_IN_TIME = "update ticket set IN_TIME= ?  where ID= ?";
    public static final String TOTAL_NB_TICKET= "select count(distinct ID) as result from ticket";
}
